        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    ...
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Halaman Stok Kandang</h1>
                    </div>
                    <div class="col-auto">
                            ...
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                <div class="col-auto">
                                    <form class="table-search-form row gx-1 align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="create-cage" class="btn app-btn-secondary">
                                                <i class="fa-solid fa-plus"></i> Tambah Kandang 
                                            </a>
                                        </div>
                                        {{-- <div class="col-auto">
                            ...
                            <div class="row g-3 mb-2 align-items-center justify-content-between">
                                ...
                                <div class="col-auto">
                                    <div class="page-utilities">
                                        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                            <div class="col-auto">
                                                <form action="/cage" method="GET" class="table-search-form row gx-1 align-items-center">
                                                    <div class="col-auto">
                                                        <input type="search" id="search-orders" name="search"
                                                            class="form-control search-orders" placeholder="Search Kode Kandang">
                                                    </div>  
                                                </form>
                                            </div>
                                        </div> <!--//row-->
                            ...
                            <div class="app-card-body">
                                <div class="table-responsive rounded">
                                    <table class="table app-table-hover mb-0 text-left">
                                        <thead>
                                            <tr>
                                                <th class="cell">Kode Kandang</th>
                                                <th class="cell">Nama Kandang</th>
                                                <th class="cell">Ukuran</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="cell">{{ $item->kode_kandang }}</td>
                                                <td class="cell">{{ $item->nama_kandang }}</td>
                                                <td class="cell">{{ $item->size->size }}</td>
                                                <td class="cell">Rp {{ number_format($item->size->harga) }}</td>
                                                <td class="cell">{{ $item->status->status }}</td>
                                                ...
                                                <td class="cell">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                          <li><a class="dropdown-item" href="{{ url('edit-cage', $item->id) }}}">Edit</a></li>
                                                          <li><a class="dropdown-item" href="{{ url('delete-cage', $item->id) }}}">Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
