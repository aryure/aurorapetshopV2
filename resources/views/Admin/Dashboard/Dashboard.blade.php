...
<head>
    ...
    <!-- FontAwesome JS-->
    <script defer src="AdminPortal/assets/plugins/fontawesome/js/all.min.js"></script>
...
<body class="app">
    ...
    <!-- Charts JS -->
    <script src="AdminPortal/assets/plugins/chart.js/chart.min.js"></script>
    <script src="AdminPortal/assets/js/index-charts.js"></script>
