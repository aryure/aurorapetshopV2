    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="font-navbar nav-link active" aria-current="page" href="#">Beranda</a>
          </li>
          <li class="nav-item">
            <a class="font-navbar nav-link" href="#">Tentang Kami</a>
          </li>
          <li class="nav-item">
            <a class="font-navbar nav-link" href="#">Perlengkapan</a>
          </li>
          <li class="nav-item">
            <a class="font-navbar nav-link" href="#">Penitipan</a>
          </li>
          <li class="nav-item">
            <a class="font-navbar nav-link" href="#">Adopsi</a>
          </li>
          <li class="nav-item">
            <a class="font-navbar nav-link" href="#">kesehatan</a>
          </li>
        </ul>
